...
export default function App() {
  ...
  return (
    <>
      ...
      <nav>
        {/* 👇 CDP : remplace "#" par l'URL de ta page d'authentification */}
        <a href="#" className="nav-btn btn-cdp">CDP</a>

        {/* 👇 SOS : remplace "#" par l'URL de ton autre page */}
        <a href="#" className="nav-btn btn-sos">SOS</a>
      </nav>
